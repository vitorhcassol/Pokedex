<template>
    <div id="header">
        <a href="https://github.com/vitorhcassol" target="_blank">
            <svg fill="#ffffff" height="3.5rem" width="3.5rem" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
